(custom-set-variables
 ...
 '(package-selected-packages
   '(vterm ivy-posframe lsp-treemacs treemacs-projectile treemacs yaml-mode web-mode lsp-ui company-lsp json-mode js2-mode rainbow-mode elisp-slime-nav rainbow-delimiters company counsel swiper ivy exec-path-from-shell zop-to-char zenburn-theme which-key volatile-highlights undo-tree super-save smartrep smartparens operate-on-number nlinum move-text magit projectile imenu-anywhere hl-todo guru-mode gitignore-mode gitconfig-mode git-timemachine gist flycheck expand-region epl editorconfig easy-kill diminish diff-hl discover-my-major crux browse-kill-ring anzu ag ace-window))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :extend nil :stipple nil :background "#000000" :foreground "#eaeaea" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 160 :width normal :foundry "nil" :family "Cascadia Code"))))
 '(deadgrep-filename-face ((t (:inherit bold :foreground "SlateBlue1"))))
 '(deadgrep-match-face ((t (:foreground "SkyBlue2"))))
 '(info-xref ((t (:inherit nil :foreground "SkyBlue1"))))
 '(info-xref-visited ((t (:foreground "Magenta" :underline nil))))
 '(package-name ((t (:inherit nil :foreground "LightSkyBlue1"))))
 '(swiper-line-face ((t (:background "#555555" :underline nil)))))
